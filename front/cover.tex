...
为了解决上述问题，进一步推动RISC-V在高校教学中的沉淀，促进RISC-V的传播，本论文讨论了一种基于C语言的RISC-V操作系统的设计，基于模块对整个工程进行划分，随后进一步细化了各个模块的具体设计，譬如中断的模式、线程调度算法等，并主要给出各个模块的实现细节，最后针对此操作系统，给出了一份比较详细的实现文档。
